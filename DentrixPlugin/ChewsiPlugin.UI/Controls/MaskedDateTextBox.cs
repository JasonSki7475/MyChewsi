...
{
    /// <summary>
    /// Code based on https://github.com/xivSolutions/MaskedDateTextBox
    /// </summary>
    internal class MaskedDateTextBox : MaskedTextBox
    {
        ...
        private const string DefaultMask = "00/00/0000";
        private const char DefaultPrompt = '_';
        ...
        {
            _requireValidEntry = requireValidEntry;

            // This is the only mask that will work in the current implementation:
            Mask = DefaultMask;
            PromptChar = DefaultPrompt;

            Enter += MaskedDateTextBox_SelectAllOnEnter;
            PreviewKeyDown += MaskedDateBox_PreviewKeyDown;
        ...
        protected override void OnLeave(EventArgs e)
        {
            ...
            {
                OnInvalidDateEntry(this, new InvalidDateTextEventArgs(Text.Trim()));
        ...
        protected virtual void OnInvalidDateEntry(object sender, InvalidDateTextEventArgs e)
        {
            if (_requireValidEntry)
            {
                ...
                Focus();
                MaskedDateTextBox_SelectAllOnEnter(this, new EventArgs());
            }
        }
